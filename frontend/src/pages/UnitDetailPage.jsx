...
import GeneralUnitPage from '../components/learn/GeneralUnitPage';
import PracticeUnitPage from '../components/practice/PracticeUnitPage';

/**
 * 단원 상세. 단원 type 에 따라 분기한다.
 * - GENERAL: 학습 + 빈칸 채우기 페이지 (4단계)
 * - PRACTICE: 실습 시뮬레이터 (5단계) — 지금은 빈 페이지 유지
 *
...
export default function UnitDetailPage() {
  ...
  return <GeneralUnitPage unit={unit} />;
}
